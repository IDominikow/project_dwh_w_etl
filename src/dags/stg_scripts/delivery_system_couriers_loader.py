...
class ApiReader:
    ...
    def list_jsons(self,limit: int, offset: int,sort_field: str, sort_direction: str):
...
class CouriersLoader:
    ...
    def load_from_api(self):
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.origin.list_jsons(CouriersLoader.limit,last_loaded,CouriersLoader.sort_field,CouriersLoader.sort_direction)
